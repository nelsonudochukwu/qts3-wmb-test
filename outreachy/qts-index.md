...
This documentation provides an introduction to QS 3.0 features, usage, and best practices. Click [here](#qs-3.0) to jump right in. However, to fully grasp the features of quickstatements 3.0, it is important to first understand the major constituent of Quickstatements⎯ _Wikidata._
